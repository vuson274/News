...
@section('content')
    <div class="col-lg-12">
        ...
        <div class="modal fade" id="modalinsert" >
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="{{route('admin.user.doAdd')}}"  method="post"   role="form" enctype="multipart/form-data">
                        @csrf
        ...
        <div class="modal fade" id="modalupdate" >
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="{{route('admin.user.doEdit')}}"  method="post"   role="form" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-header">
